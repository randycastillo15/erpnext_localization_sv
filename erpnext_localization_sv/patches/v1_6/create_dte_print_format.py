"""
Patch v1.6 — Crea el Print Format "DTE El Salvador" para Sales Invoice.

Características:
  - Sin dependencias de servicios externos (no usa api.qrserver.com ni similares).
  - Muestra la URL de verificación MH como texto cuando sv_dte_qr_url está poblada.
  - La imagen QR queda pendiente para Sprint 7 (requiere confirmar URL oficial MH).
  - Idempotente: si el formato ya existe, actualiza el HTML.
"""
...
<style>
  ...
  table.meta td { padding: 2px 6px 2px 0; }
